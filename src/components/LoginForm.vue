  ...
  <div class="form-container">
    ...
    <form @submit.prevent="submitForm" class="form">
      <div class="input-group">
        ...
        <input type="text" name="email" id="email" placeholder="Email" v-model="email" autocomplete="username"
          required />
      </div>
      <div class="input-group">
    ...
    <p class='succes-text' v-if="logged">{{ logged }}</p>
  </div>
</template>
<script>
  ...
  methods: {
    async submitForm() {
      ...
      try {
        ...
        this.error = ''
        this.logged = response.data.message
